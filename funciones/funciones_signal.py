...
#                                                                         %
#  Descripcion:               
#  Aqui se encuentran las funciones utilizadas en la funcion simulador n  %
#  Estas funciones hacen de soporte para la funcion simulador             %
#  y representan todas la funciones que se necesitan para crear una       %
#  funcion
#                               Versión 1.0.0
#--------------------------------------------------------------------------
